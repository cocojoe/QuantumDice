...
class TabbarMenu: UIView{
    ...
    let TOPSPACE : CGFloat = 16 //留白
    let adjustmentVertical: CGFloat = 64.0
    ...
    private func setUpViews()
    {
        ...
        // Main Menu
        let menuView = NSBundle.mainBundle().loadNibNamed("MenuView", owner: self, options: nil).first as! UIView
